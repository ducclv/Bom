...
public class Screen {
	...
	public void drawWinGame(Graphics g, int points) {
		...
		g.setFont(font);
		g.setColor(Color.white);
		drawCenteredString("GAME WIN", getRealWidth(), getRealHeight(), g);
	...
	public void drawHigh(Graphics g, int points) {
		g.setColor(Color.black);
		g.fillRect(0, 0, getRealWidth(), getRealHeight());
		...
		g.setFont(font);
		g.setColor(Color.white);
		drawCenteredString("LE VAN DUC", getRealWidth(), getRealHeight(), g);
